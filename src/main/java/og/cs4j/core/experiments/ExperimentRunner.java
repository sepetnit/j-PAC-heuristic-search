...
public abstract class ExperimentRunner {
     ...
     */
    protected Constructor<?> getSearchDomainConstructor(Class domainClass) {
     ...
     *
     */
    protected SearchDomain getSearchDomain(String inputPath, HashMap<String, String> domainParams, Constructor<?> cons, int i){
        InputStream is = null;
